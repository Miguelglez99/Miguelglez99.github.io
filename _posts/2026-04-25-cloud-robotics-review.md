...
Robotic surgery has become one of the most iconic examples of how technology can transform healthcare. Systems like the **Da Vinci Surgical System** ([official description by Intuitive Surgical](https://www.intuitive.com/en-us/products-and-services/da-vinci)) have changed the way many procedures are performed, improving precision, ergonomics and visualization. However, a new layer of innovation is emerging on top of these platforms: **cloud robotics.**
